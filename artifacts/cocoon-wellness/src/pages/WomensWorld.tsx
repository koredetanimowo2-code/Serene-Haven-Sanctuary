...
const services = [
  { name: "Signature Full Body Massage", price: "from ₦25,000 / $45 / £35", desc: "Deep tissue relief, hot towels, custom aromatherapy oils.", img: "/images/service-women-1.png" },
  { name: "Luxury Manicure", price: "from ₦9,000 / $18 / £14", desc: "Nail shaping, cuticle care, gel or classic polish, warm hand massage.", img: "/images/service-women-2.png" },
  { name: "Luxury Pedicure", price: "from ₦10,000 / $20 / £16", desc: "Soothing foot soak with rose petals, scrub, nail care, polish.", img: "/images/service-women-3.png" },
  { name: "Glow Facial", price: "from ₦18,000 / $35 / £28", desc: "Deep cleanse, steam, exfoliation, mask, moisturize, lymphatic massage.", img: "/images/service-women-4.png" },
  { name: "Full Body Waxing", price: "from ₦15,000 / $30 / £24", desc: "Gentle, professional, using premium skin-kind wax formulas in complete privacy.", img: "/images/service-women-5.png" },
  { name: "Hot Stone Therapy", price: "from ₦28,000 / $55 / £44", desc: "Heated volcanic stones, pressure point work, full back release.", img: "/images/service-women-6.png" },
  { name: "Aromatherapy Ritual", price: "from ₦20,000 / $40 / £32", desc: "Custom-blended essential oils, 60-minute full body sensory experience.", img: "/images/service-women-7.png" }
];
